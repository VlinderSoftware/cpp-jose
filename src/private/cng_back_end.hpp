...
{
public:
    CNGECKey(std::string curve_name, std::vector<unsigned char> const& x,
             std::vector<unsigned char> const& y, std::vector<unsigned char> const& d,
    ...
    bool hasPrivate() const override;
    std::unique_ptr<Private::Key> clone() const override;
    virtual std::vector<unsigned char> getX() const override { return x_; }
    virtual std::vector<unsigned char> getY() const override { return y_; }
    virtual std::vector<unsigned char> getD() const override { return d_; }
...
public:
    ...
    generateRSA(std::vector<unsigned char> const& n_bytes, std::vector<unsigned char> const& e_bytes,
